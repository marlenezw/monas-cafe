...
/**
 * Prices arrive from the CMS pre-formatted ("$3.50"). parseFloat stops at the
 * leading currency symbol and returns NaN, so strip everything that isn't a
 * digit or decimal point before parsing.
 */
